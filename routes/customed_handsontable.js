...
router.get('/', function (req, res, next) {
    res.render('customed_handsontable', {
        "title": 'customed_handsontable'
    });
});
...
router.post('/complete', function (req, res, next) {
    ...
    var db = req.db;
    var test_cols = db.get('customed_handsontable');
    test_cols.update({
            "_id": selId
        },
            {
            ...
            function (err, doc) {
                if (err) {
                    ...
                    // res.location('/customed_handsontable');
                    // res.redirect('/customed_handsontable');
